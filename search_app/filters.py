...
class ExperienceFilter(django_filters.FilterSet):
    ...
    region = django_filters.CharFilter(field_name="region__region_name", lookup_expr="exact" , label="Region name")
    experience_tag = django_filters.CharFilter(field_name="experience_tags__tag_name", lookup_expr='contains' , label="Experience tags")
    class Meta:
        model = Experience
        fields = []
...
class SecondFilter(django_filters.FilterSet):
    ...
    host__username = django_filters.CharFilter(field_name='host__user__username',lookup_expr='exact',label="Host name")
